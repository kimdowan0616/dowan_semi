		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="category_down"
					...
					<li><a class="dropdown-item" value="furniture" href="store_category_furniture.jsp">가구</a></li>
					<li><a class="dropdown-item" value="fabric" href="store_category_fabric.jsp">패브릭</a></li>
					<li><a class="dropdown-item" value="homeElec" href="store_category_homeElec.jsp">가전</a></li>
					<li><a class="dropdown-item" value="life" href="store_category_life.jsp">생활용품</a></li>
					<li><a class="dropdown-item" value="pet" href="store_category_pet.jsp">반려동물</a></li>
				</ul>
				...
				<ul class="navbar-nav ms-left">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded">
							<form class="d-flex" name="frmSearch" method="post" action='store_keyword.jsp'>
