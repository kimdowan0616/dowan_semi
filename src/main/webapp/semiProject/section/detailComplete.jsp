		...
		$('#btnImageloading')
				.click(
						function() {
							...
							$('#image-top')
									.html(
											'<img class="i1" src="../assets/img/item/300004_detail_1.jpeg" alt="" />'
													+ '<img class="i1" src="../assets/img/item/300004_detail_2.jpeg" alt="" />'
													+ '<img class="i2" src="../assets/img/item/300004_detail_3.jpeg" alt="" />'
													+ '<img class="i2" src="../assets/img/item/300004_detail_4.jpeg" alt="" />'
													+ '<img class="i2" src="../assets/img/item/300004_detail_5.jpeg" alt="" />'
													+ '<img class="i2" src="../assets/img/item/300004_detail_6.jpeg" alt="" />');
				...
				<table>
					...
					<tr>
						<th id="image-top" style="border: 2px solid gray" width="1050px"><img
							src="../assets/img/item/300004_detail_1.jpeg" /></th>
					</tr>
					<tr>
